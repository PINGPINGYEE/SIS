<template>
  <div class="wrapper">
    ...
    <div class="header">
      ...
      <div class="header-inform">
        <div class="sns">
          ...
          &nbsp;&nbsp;&nbsp;
          <a href="https://www.youtube.com" target="_blank" style="text-decoration:none;color:black;"><img
              src="../assets/youtube.svg" alt="instagram"> soul in seoul</a>
          ...
          <tbody>
            <tr v-for="item in items" :key="item.Date">
              <span class="dot-container">
                <td v-if="item.Type === 'red'" class="dot" style="background-color: red;" v-tooltip title="Healing">
                </td>
                <td v-else-if="item.Type === 'blue'" class="dot" style="background-color: blue;" v-tooltip
                  title="Dynamic"></td>
                <td v-else-if="item.Type === 'yellow'" class="dot" style="background-color: yellow;" v-tooltip
                  title="University">
                </td>
    ...
    <div class="summary-wrapper">
      <div class="summary-background"></div> <!-- 추가된 배경용 div -->
      <div class="summary-contents">
        <!-- magazine -->
        <div class="magazine" :class="magazineClass" @mouseover="hoverMagazine = true" @mouseleave="hoverMagazine = false">
  <div class="section-title">Magazine</div>
        ...
        <!-- youtube -->
        <div class="youtube" @mouseover="hoverYoutube = true" @mouseleave="hoverYoutube = false">
...
<script>
  export default {
    ...
    methods: {
      ...
      toggleZoom(section) {
        if (section === 'magazine') {
          this.hoverMagazine = !this.hoverMagazine;
        } else if (section === 'youtube') {
          this.hoverYoutube = !this.hoverYoutube;
        }
      },
      toggleMagazineHover() {
      this.hoverMagazine = true;
      this.hoverYoutube = false;
    },
    toggleYoutubeHover() {
      this.hoverYoutube = true;
      this.hoverMagazine = false;
    },
  },
    ...
    magazineClass() {
      return {
        'hide': this.hoverYoutube
      };
    },
    youtubeClass() {
      return {
        'hide': this.hoverMagazine
      };
    }
  },
    }
...
<style scoped>
  ...
  .summary-background {
    background-color: rgb(174, 197, 140);
  ...
  .youtube {
    ...
    height: 350px;
    margin: 2px 20px;
    transition: z-index 0.5s ease, transform 0.5s ease;
  }
...
.magazine:hover ~ .youtube .section-title {
  visibility: hidden; /* youtube 섹션과 제목을 숨김 */
}

/* youtube 섹션이 활성화되었을 때 magazine을 가리기 */
.youtube:hover ~ .magazine,
.youtube:hover ~ .magazine .section-title {
  visibility: hidden; /* magazine 섹션과 제목을 숨김 */
}
...
.magazine:hover .section-title {
  transform: translateX(-550%); /* 왼쪽으로 이동 */
}

.youtube:hover .section-title {
  transform: translateX(495%); /* 오른쪽으로 이동 */
}


.youtube .section-title {
  transform-origin: right center; /* Adjust this if needed */
}
  ...
  .recommend ::v-deep .nav-link:focus,
  .nav-link:hover {
    color: rgb(0, 165, 0);
  }
